...
Si el taller fue realizado en grupo, describe exactamente lo que hiciste:

```markdown
- Implementé el ShaderMaterial personalizado con Lambert y preparé el pipeline para Phong/Blinn-Phong
- Integré dat.GUI para ajustes en tiempo real de la luz y otros parámetros
- Confronté renders entre diferentes materiales y geometrías
- Documenté el README y añadí ejemplos de código
```
